...
FilenameModel: "model_higgs.h5" [Filename of the initial Keras model]
FilenameTrainedModel: "trained_model_higgs.h5" [Filename of the trained output Keras model]
