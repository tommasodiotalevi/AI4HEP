...
- [FPGA_Inference_Muon](FPGA_Inference_Muon/): Third hands-on on a regression use-case, the assigment of muon momentum ($p_{T}$), and its FPGA implementation for fast inference.
- [DQM with Autoencoders](DQMwithAE/): Fourth hands-on on the use of Autoencoders for Data Quality Monitoring (DQM) in HEP experiments.
