...
> [!NOTE]  
> This hands-on is taken from the ML-INFN Knowledge base, more info [in this link](https://confluence.infn.it/spaces/MLINFN/pages/109151730/14.+Signal-background+classification+with+Parametric+Neural+Networks) (credits L.Anzalone, T.Diotalevi)
